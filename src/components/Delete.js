...
const Delete =({show, confirm,hide,type, data}) =>{
    return(
        <Modal show={show} onHide={hide} centered data-cy='modal-delete'>
            ...
            <Modal.Footer className="border-0 justify-content-center pb-5">
                ...
                <Button variant="red" className="rounded-pill px-4 fw-semibold" onClick={hide} data-cy='modal-delete-confirm-button'>Hapus</Button>
            </Modal.Footer>
        </Modal>
    )
}
